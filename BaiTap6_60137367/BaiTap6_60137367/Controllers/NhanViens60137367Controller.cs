...
using BaiTap6_60137367.Models;

namespace BaiTap6_60137367.Controllers
{
    public class NhanViens60137367Controller : Controller
    {
        private QLNV_60137367Entities1 db = new QLNV_60137367Entities1();
        ...
        string LayMaNV()
        {
            ...
            string NV = String.Concat("", maNV.ToString());
